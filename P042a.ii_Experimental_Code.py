...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 11:29:48 2026
...
class ExperimenterControlPanel(object):
    ...
    def __init__(self):
        ...
        # Subject ID
        self.pigeon_name_list = ["Thoth", "Joplin", "Odin", "Mario", "Luigi", "Itzamna"]
...
# CHANGE LUIGI HOPPER TO 4s here
    ...
    def first_ITI(self, event):
        ...
        # iteration 1: 
            # Extinction A = Joplin Itzamna
            # Extinction X = Luigi Thoth
            # Extinction C = Odin Mario
            
        # iteration 2: 
            ## column 1 = first color, column 2 = second
            # Extinction A = Thoth Odin 
            # Extinction X = Joplin Mario
            # Extinction C = Itzamna Luigi
        ...
        # BLUE X
        if self.subject_ID in ["Joplin", "Thoth", "Itzamna", "TEST"]: 
            self.COLORS = {
                "A": "#00A6A6", # teal
                "B": "#FF6F00", # orange
                "C": "#4267FC", # blue
        ...
        #YELLOW X
        elif self.subject_ID in ["Odin", "Mario", "Luigi"]:
            self.COLORS = {
                "A": "#00A6A6", # teal
                "B": "#FF6F00", # orange
                "C": "#4267FC", # blue
...
####Don't worry about for now -------------------------------------------------
    ...
    def _draw_triangle(self, x1, y1, x2, y2, color, orientation="up"):
        if orientation == "up":
            points = [
    ...
    def _draw_stimulus_rects(self, trial_type: str):
        """
        Draw triangles (all oriented up) using the same bounding box dimensions.
        """
        def cell_to_xy(r, c):
        ...
        def draw_cells(stim_key):
            color = self.COLORS[stim_key]
            for r, c in self.POSITIONS[stim_key]:
                x1, y1, x2, y2 = cell_to_xy(r, c)
                
                self._draw_triangle(x1, y1, x2, y2, color, orientation="up")
